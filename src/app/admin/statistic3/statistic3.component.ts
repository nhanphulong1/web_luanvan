...
@Component({
    ...
    styleUrls: ['./statistic3.component.scss']
})
export class Statistic3Component implements OnInit {

    displayedColumns: string[] = ['stu_code', 'stu_name', 'stu_email', 'stu_gender', 'cou_name', 'cla_course', 'cla_code', 'tea_name', 'ex_date', 'ex_location', 'pay_type', 're_result'];
